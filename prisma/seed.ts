  ...
  const pages: SeedPillarPage[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { heading: "The Suites at Midpoint", text: "Corporate accommodation is intended for visiting executives, project teams and short-term stays. Confirm current availability, finished specification, eligibility and the booking process before making travel arrangements.", image: "/images/listings/corporate-accommodation.png", alt: "Architectural visualisation of proposed corporate accommodation at Midpoint" },
    ...
    },
    {
      ...
      faqs: [
        ...
        { question: "Who do I contact about access or commute questions?", answer: "Contact Boitumelo, Property Manager, on +27 11 380 9400 or boitumelo@blendproperty.co.za." },
      ],
