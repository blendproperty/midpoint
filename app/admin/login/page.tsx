  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-midpoint-dark px-6">
      <div className="w-full max-w-sm rounded-card bg-white p-8">
        <h1 className="text-2xl font-semibold text-midpoint-dark">Midpoint Admin</h1>
        <p className="mt-1 text-sm text-midpoint-grey-400">Sign in to manage site content.</p>
