...
const items = [
  {
    title: "Offices",
    text: "Conventional office suites in a range of sizes and configurations. See each live listing for the current fit-out and specification.",
    href: "/offices",
    cta: "Explore offices",
    image: "/images/listings/2-weaver-avenue.png",
    sectorKey: "office" as const,
    highlights: ["Live sizes and rates", "Unit-specific details", "Viewings available"],
    featured: true,
  },
  {
    title: "Warehouses",
    text: "Warehouse and industrial opportunities. Loading, yard, height and power details vary by unit and are shown where confirmed.",
    href: "/warehouses",
    cta: "Explore warehouses",
    image: "/images/pillars/warehouses/warehouse-exterior.webp",
    sectorKey: "warehouse" as const,
    highlights: ["Live availability", "Unit specifications", "Inspection access"],
    featured: false,
  },
  {
    title: "Serviced offices",
    text: "OnPoint workspace for smaller teams, project offices and businesses establishing a Midrand presence.",
    href: "/services-offices",
    cta: "Explore serviced offices",
    image: "/images/listings/onpoint.jpeg",
    sectorKey: "servicedOffice" as const,
    highlights: ["Published suite sizes", "Current rates", "OnPoint at Midpoint"],
    featured: false,
  },
];
