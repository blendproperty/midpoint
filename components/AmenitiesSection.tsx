  ...
  return (
    ...
    >
      ...
      {/* Sliding card strip with edge fade — real values extracted via
          Playwright: white cards (12px radius, 240px wide), subtle icon
          background, linear-gradient mask fading both edges. */}
      <div
      ...
      >
        <div className="flex w-max animate-marquee gap-4">
          {row.map((a, i) => (
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-[rgba(161,189,217,0.08)]">
                <Image src={a.icon} alt="" width={28} height={28} />
              </div>
